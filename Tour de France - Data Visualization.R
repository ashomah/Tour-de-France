...
### All documents of this project can be found on GitHub: [Tour de France](https://github.com/ashomah/Tour-de-France).
### The code can be found on GitHub as a Gist: [Tour de France Code](https://gist.github.com/ashomah/a4d041e1965c4b41e783228a9c43fc06).
